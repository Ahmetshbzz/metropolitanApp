...
export const createButtonStyle = (size: ButtonSizeConfig, variantStyle: ViewStyle, fullWidth: boolean, isDisabled: boolean, variant: ButtonVariant): ViewStyle => ({
  ...size,
  ...variantStyle,
  flexDirection: "row",
  alignItems: "center",
...
export const createTextStyle = (size: ButtonSizeConfig, textColor: string): TextStyle => ({
  color: textColor,
